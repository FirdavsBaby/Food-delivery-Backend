...
export const confirmationPurchase = async(req:AuthRequest,res:Response,next: NextFunction): Promise<void> => {
    try {
        const {id} = req.params
...
export const PurchaseAtCourier = async(req:AuthRequest,res:Response,next:NextFunction): Promise<void> => {
    try {
...
export const EndPurchase = async(req:AuthRequest,res:Response,next: NextFunction): Promise<void> => {
    try {
        const {id} = req.params
        const {id : user_id} = req.user as UserT
...
export const History = async(req:AuthRequest,res:Response,next:NextFunction): Promise<void> => {
    try {
        const {id : user_id} = req.user as UserT
